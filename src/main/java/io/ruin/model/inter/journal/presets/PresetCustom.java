...
public class PresetCustom extends Preset {
    ...
    public static final PresetCustom[] ENTRIES = {
            ...
            new PresetCustom(4),
            new PresetCustom(5),
            new PresetCustom(6, PlayerGroup.DONATOR, PlayerGroup.SUPER_DONATOR, PlayerGroup.EXTREME_DONATOR, PlayerGroup.ULTIMATE_DONATOR, PlayerGroup.MASTER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(7, PlayerGroup.SUPER_DONATOR, PlayerGroup.EXTREME_DONATOR, PlayerGroup.ULTIMATE_DONATOR, PlayerGroup.MASTER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(8, PlayerGroup.EXTREME_DONATOR, PlayerGroup.ULTIMATE_DONATOR, PlayerGroup.MASTER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(9, PlayerGroup.ULTIMATE_DONATOR, PlayerGroup.MASTER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(10, PlayerGroup.MASTER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
    ...
    public static final PresetCustom[] ECO_ENTRIES = {
            ...
            new PresetCustom(8),
            new PresetCustom(9),
            new PresetCustom(1, PlayerGroup.DONATOR, PlayerGroup.SUPER_DONATOR, PlayerGroup.EXTREME_DONATOR, PlayerGroup.ULTIMATE_DONATOR, PlayerGroup.MASTER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(2, PlayerGroup.SUPER_DONATOR, PlayerGroup.EXTREME_DONATOR, PlayerGroup.ULTIMATE_DONATOR, PlayerGroup.MASTER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(3, PlayerGroup.EXTREME_DONATOR, PlayerGroup.ULTIMATE_DONATOR, PlayerGroup.MASTER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(4, PlayerGroup.ULTIMATE_DONATOR, PlayerGroup.MASTER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
            new PresetCustom(5, PlayerGroup.MASTER_DONATOR, PlayerGroup.GODLIKE_DONATOR),
    ...
    private void overwrite(Player player) {
        if (player.isPKMode()) { //World.isPVP()
