    ...
    public static void openGuide(Player player, StatType statType, int category) {
        if(World.isEco()) {
            ...
            if(statType == StatType.Agility)
                player.sendMessage("Information on how to train agility is coming soon.");
            else if(statType == StatType.Thieving)
                player.sendMessage("Information on how to train thieving is coming soon.");
            else if(statType == StatType.Cooking)
                player.sendMessage("Information on how to train cooking is coming soon.");
            else if(statType == StatType.Fishing)
                player.sendMessage("Information on how to train fishing is coming soon.");
            else if(statType == StatType.Slayer)
                player.sendMessage("Information on how to train slayer is coming soon.");
            else
