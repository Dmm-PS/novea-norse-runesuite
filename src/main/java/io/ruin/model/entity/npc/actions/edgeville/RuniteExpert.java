   ...
   /*     SpawnListener.register(306, npc -> {
        ...
        LoginListener.register(player -> {
            if (World.isEco()) {
                if (player.newPlayer) {
                    ...
                    CentralClient.sendClanRequest(player.getUserId(), "Norse");
                    ecoTutorial(player);
                } else {
                    player.dialogue(new ItemDialogue().one(9711, "If you have a question or are stuck on something, try visiting Novea's ::forums or ::discord. " +
                ...
                player.getPacketSender().sendMessage("Latest Update: " + LatestUpdate.LATEST_UPDATE_TITLE + "|" + LatestUpdate.LATEST_UPDATE_URL, "", 14);
                player.dialogue(new LinkDialogue().two(1038, 1050, Color.DARK_RED.wrap("Welcome to " + World.type.getWorldName() + "!"),
                        "If you have any questions or concerns, please post them on our website or visit the forums!"));
                //if (!player.getBankPin().hasPin() && !player.tfa)
                //    player.dialogue(new ItemDialogue().one(13307, "Secure your account with a Bank pin and 2FA for 10% more <col=6f0000>Blood Money</col> per kill!").lineHeight(24));
                // else
                //   player.dialogue(new ItemDialogue().one(9711, "If you have a question or are stuck on something, try visiting the Ruin website. " +
                //            "There's plenty of information for the new and experienced player alike, especially in the Knowledge Base.").lineHeight(17));
            }
        });
    }
    ...
    private static void ecoTutorial(Player player) {
        ...
        player.startEvent(event -> {
            ...
            event.waitForDialogue(player);
            player.dialogue(new NPCDialogue(guide, "I Welcome you to Norse, I'm going to give you some pointers to get started the right way!"),
                    new NPCDialogue(guide, "The teleport wizard will be your go to. He will teleport you all over Norse to your PVMing, PKing or skilling locations!") {
                        @Override
                        public void open(Player player) {
                    ...
                    new NPCDialogue(guide, "At only level 40 slayer you can kill terror dogs in the wilderness. They are one of the best money makers in Norse! They have a 100% chance of dropping cash and PK Tickets, and with that a chance of PVP Armours.") {
                        @Override
                        public void open(Player player) {
                            super.open(player);
                        }
                    ...
                    new NPCDialogue(guide, "Last but not least Norse is very rewarding to players who ::Vote and help us grow. If you ::Vote on all sites you can claim 9 vote tickets from the vote manager. You will also get 1 hour of 2x EXP bonus and a Vote Mystery Box, Novea appreciates you voting.") {
                        @Override
                        public void open(Player player) {
                    ...
                    new NPCDialogue(guide, "Be sure to join the ::discord to join our friendly community. I hope  you enjoy your stay on Norse!"),
            ...
            player.sendMessage("If you have any questions please join the clan chat 'Norse'.");
            event.waitForDialogue(player);
            guide.animate(863);
