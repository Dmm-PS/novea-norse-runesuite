...
public class Player extends PlayerAttributes {
    ...
    public boolean isSeniorModerator() {
        return isGroup(PlayerGroup.SENIOR_MODERATOR) || isGroup(PlayerGroup.DISCORD_MANAGER) || isGroup(PlayerGroup.EVENTS_MODERATOR) || (World.isEco() && isGroup(PlayerGroup.ADMINISTRATOR));
    }
    ...
    public boolean isDonator() {
        return isGroup(PlayerGroup.DONATOR) || isGroup(PlayerGroup.EXTREME_DONATOR) || isGroup(PlayerGroup.GODLIKE_DONATOR)
                || isGroup(PlayerGroup.MASTER_DONATOR) || isGroup(PlayerGroup.SUPER_DONATOR) || isGroup(PlayerGroup.ULTIMATE_DONATOR);
    }
