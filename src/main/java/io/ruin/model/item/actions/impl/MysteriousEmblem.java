        ...
        for(int[] emblem : emblems) {
            ...
            ItemAction.registerInventory(def.id, "info", (player, item) -> {
                player.sendScroll("<col=800000>About Mysterious Emblems",
                        ...
                        "",
                        Color.DARK_RED.wrap("Tier 1 ") + "           150 wilderness points",
                        Color.DARK_RED.wrap("Tier 2 ") + "           250 wilderness points",
                        Color.DARK_RED.wrap("Tier 3 ") + "           375 wilderness points",
                        Color.DARK_RED.wrap("   Tier 4 ") + "         500 wilderness points",
                        Color.DARK_RED.wrap("   Tier 5 ") + "         750 wilderness points",
                        Color.DARK_RED.wrap("   Tier 6 ") + "         1,000 wilderness points",
                        Color.DARK_RED.wrap("   Tier 7 ") + "         1,500 wilderness points",
                        Color.DARK_RED.wrap("   Tier 8 ") + "         2,500 wilderness points",
                        Color.DARK_RED.wrap("   Tier 9 ") + "         3,750 wilderness points",
                        Color.DARK_RED.wrap("   Tier 10 ") + "        5,000 wilderness points"
                );
            });
