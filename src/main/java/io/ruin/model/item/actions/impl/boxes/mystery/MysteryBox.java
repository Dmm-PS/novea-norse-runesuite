...
public class MysteryBox {
    ...
    private static final LootTable MYSTERY_BOX_TABLE = new LootTable().addTable(1,
            ...
            new LootItem(13307, 1000, 5000, 25), //2000 Blood money
            ...
            new LootItem(13307, 4500, 10000, 25), //6k Blood money
            new LootItem(13307, 6000, 10000, 25), //8k Blood money
            ...
            new LootItem(13307, 25000, 35000, 1), //30k Blood money
            new LootItem(13307, 80000, 90000, 1), //90k Blood money
            new LootItem(13307, 35000, 45000, 1), //45k Blood money
    ...
    private static final LootTable INCENTIVE_TABLE = new LootTable().addTable(1,
            new LootItem(13307, 4500, 10000, 100), //6k Blood money
            new LootItem(13307, 6000, 10000, 100), //8k Blood money
            ...
            new LootItem(13307, 25000, 35000, 10), //30k Blood money
            new LootItem(13307, 80000, 90000, 10), //90k Blood money
            new LootItem(13307, 35000, 45000, 10), //45k Blood money
            new LootItem(11806, 1, 1), //Armadyl godsword
            new LootItem(12821, 1, 1).broadcast(Broadcast.GLOBAL), //Spectral spirit shield
            new LootItem(13271, 1, 1), //Abyssal dagger
            new LootItem(12791, 1, 1), //Rune pouch
