...
public class Leaderboard {
    ...
    static {
        ...
        World.startEvent(e -> {
            /*
             * Start event every 96 hours
             */
            while (true) {
                e.delay(Server.toTicks(3456 * 100));
                pullWinners();
            }
        });
    ...
    private static void openEdgeLeaderBoard(Player player) {
        ...
        player.getPacketSender().sendString(108, 19, "<col=FF0000>Rewards: 1st: 3x SMbox - 2nd: 2x SMbox - 3rd: 1x SMbox</col>");
    ...
    public static void pullWinners() {
        World.startEvent(event -> {
            ...
            if (topThreeEdge != null) {
                ...
                Item firstPlaceReward = new Item(290, 3);
                Item secondPlaceReward = new Item(290, 2);
                Item thirdPlaceReward = new Item(290, 1);
