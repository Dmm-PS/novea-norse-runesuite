...
public class PVPInstance {
    ...
    public static void init(List<Region> emptyRegions) {
        ...
        spawnNpc(edgeville, 535, 3097, 3499, 0, Direction.SOUTH, 0); //horvik
        removeObj(edgeville, 590, 3095, 3498, 0); //bank table
        removeObj(edgeville, 1088, 3095, 3499, 0); //bank chair
        removeObj(edgeville, 196, 3094, 3499, 0); //bank torch
        removeObj(edgeville, 196, 3097, 3499, 0); //bank torch
        removeObj(edgeville, 1276, 3090, 3503, 0); //tree
        register(
                edgeville, "Edgeville",
                3091, 3497, 3092, 3497,
