...
public class BotPrevention {
    ...
    public static void spawn(Player player) {
        ...
        player.sendMessage(Color.COOL_BLUE.wrap("A guard has suspicion you've been stealing from Norse."));
    ...
    static {
        NPCAction.register(PILLORY_GUARD, "talk-to", (player, npc) -> {
            if(npc.ownerId != player.getUserId()) {
                ...
                player.dialogue(new NPCDialogue(PILLORY_GUARD, "I've gotten reports that you've been stealing from Norse, "
