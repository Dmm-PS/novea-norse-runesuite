...
public class World extends EventWorker {
    ...
    public static boolean wildernessKeyEvent = true;
    public static void toggleDmmKeyEvent() {
        wildernessKeyEvent = !wildernessKeyEvent;
    }

    public static boolean wildernessDeadmanKeyEvent = true;
        ...
        Server.afterData.add(() -> {
            ...
            if(isPVP()) {
                ...
                announcements = Arrays.asList(
                        ...
                        "Don't forget to ::Vote and test your luck on a voting mystery box daily!",
                        "Type ::Discord to join our Community and engage with the playerbase!",
                        "Want to donate with OSRS GP? PM Chris T or Parker on ::Discord!"
                );
            }
